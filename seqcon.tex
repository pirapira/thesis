...
\label{ch:seqcon}
  ...
  \begin{definition}
   \label{formula}
   We define a \index{\iec-formula} $\varphi$ by the BNF:
   \[
  ...
  \begin{definition}
   ...
   a set of \iec-formulae $\Gamma\subseteq\Omega$ is \index{$\Omega$-saturated} if and only if
   \begin{enumerate}
...
Proof to be found in the author's Master's thesis.
 ...
 \label{wf}
  ...
  \begin{definition}
   ...
   A~\index{waitfree protocol description} $\varphi$ is an \iec-formula of the form
   \[
   ...
   A~\index{waitfree assertion} is an \iec-formula~$\varphi\supset\psi$ where $\varphi$ is a
