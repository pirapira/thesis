...
\label{ch:seqcon}
  ...
  intuitionistic epistemic logic (\iec\, for short) and investigating it.
    ...
    (\thref{fmp}) and decidability (\thref{decidability}).
  ...
  \begin{definition}
   \label{formula}
   We define a \iec-formula\index{formula!\iec-formula} $\varphi$ by BNF:
   \[
  ...
  map $f_a: W\rightarrow W$ for each agent $a\in A$ where $W$ is the
...
Proof to be found in the author's Master's thesis.
 ...
 \label{wf}
  ...
  \begin{definition}
   ...
   A~waitfree task specification\index{waitfree!--- task specification} $\psi$ is defined with BNF:
   \[
...
still in the realm of modal correspondence theory \fix{cite something}.
