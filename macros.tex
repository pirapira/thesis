...
\newcommand{\hmid}{\ \ \rule[-2pt]{2pt}{11pt}\ \ }
\newcommand{\whitemid}{\ \ \framebox[-2pt]{\hskip 9pt}\ \ }
...
\newcommand{\sendtype}[2]{\mathop{!}\kern -2pt{#1}\hskip 2pt{#2}}
\newcommand{\recvtype}[2]{\mathop{?}\kern -2pt{#1}\hskip 2pt{#2}}
...
\newcommand{\imtrans}[1]{\text{\textopencorner}{#1}\text{\textcorner}}
