\chapter{A Terminating Tableau System for Sequential Consistency Logic}
 ...
 method of terminating tableau.
  ...
  \]
  where $a$ is an agent.  Especially, a composite world term\index{world
  term!composite} is a world
 ...
 \section{Related Work}
    ...
    The tableau system here is similar to \citet{dyckhoff-negri} in many
    aspects:
    \begin{itemize}
