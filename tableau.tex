 ...
 method of terminating tableau.
  ...
  and Wallen's method for intuitionistic first order predicate logic~\cite{waaler1999tableaux}.
   ...
   \begin{figure}[t]
    ...
    \small
    \begin{center}
     \fix{state that the order within a context is ignored}\\
    ...
    R$\supset$
    is finitely branching. \fix{align spaces between formula and context}}
    \label{LB}
   \end{figure}
  ...
  refutation ladder of $S$, and then there is a finite counter model.
   ...
   \begin{proof}
    ...
    By the contraposition of \thref{chooser}, the set $\bar L_u$ is included in $\bar L$.
