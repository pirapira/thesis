\chapter{Dummett's Axiom in Haskell}
\label{ch:haskell}
...
\fix{introduction must be changed}
...
\fix{are all these three subsections necessary?}
...
sequents called \textit{components}\index{component}.  Rules from ordinary sequent calculus
