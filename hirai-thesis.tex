...
\newcommand{\hmid}{\ \ \rule[-1.7px]{2px}{10px}\ \ }
...
modification of \citet{sakszaharoglou1999} \fix{cite properly}.
...
\let\spvec\vec
\let\vec\accentvec
\usepackage{bussproofs, amsmath, stmaryrd, rotating, amssymb,
setspace, float}
...
The underlying logic has the derivation rules in Fig.~\ref{logic}.  If
...
\begin{align*}
 & \concreteconf{[]}{[]}{\cotuple{\gpair{\{\ltor 0 l \epsilon {c_0}, {c_0}\}, \{{c_1}\}},
 \gpair {\{{c_0}\}, \{\rtol 1 l\epsilon {c_1}, {c_1}\}}}} \\
 \reduction &
 \concreteconf{[\l\mapsto {c_0}]}{[]}{
 \cotuple{
 \gpair{\{\abort, {c_0}\}, \{{c_1}\}},
 \gpair{\{{c_0}\}, \{\rtol 1 l\epsilon {c_1}, {c_1}\}}
 }
...
This work is encouraged by feedbacks from ACAN (Algebraic and
Coalgebraic
Approaches to
