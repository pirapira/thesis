...
In computer science, such phenomena is called nondeterminism caused by scheduling.
 \begin{figure}
  ...
  logic~\citep{casari1989,metcalfe2002}\fix{cite another from 駒場}
  ...
  \textsf{MALL}$^-$~\citep{metcalfe2006}
  is a fragment of \textsf{MALL} without
  units $\top,0,\bot$\footnote{These are the units for additive disjunction,
  additive conjunction and multiplicative disjunction.}.
