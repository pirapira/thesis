...
We list our contributions from the most important: \fix{show chapter numbers}
\begin{enumerate}
...
G\"odel--Dummett logic with waitfreedom
 ...
 \item identifying the communication performed by the prelinearity axiom
       of monoidal t-norm logic.
 \item identifying the communication performed by a seemingly unknown axiom
       $(p\limp q)\otimes(q\limp p)$ on top of multiplicative linear logic.
