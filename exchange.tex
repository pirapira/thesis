...
shown in the Sync rule occurrence introducing the communicating term.
 ...
 \begin{theorem}[Safety of Amida calculus]
  \label{safety}
...
\begin{corollary}[Prelinearity in Amida calculus]
 Prelinearity is inhabited $(\phi\limp\psi)\oplus(\psi\limp\phi)$ is
 inhabited in Amida calculus.
\end{corollary}
...
On the other hand, if we translate the conclusion to a formula
...
back to Amida calculus.  Although in that case we have to translate a
cut-free proof in \citet{metcalfe2006}'s system into a cut-free proof in
our type system.
