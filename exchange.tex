 ...
 \end{proposition}
   ...
   \end{corollary}
    ...
    consistent as the next proposition shows.
     \begin{proposition}
      ...
      \ruleskip
      \AxiomC{$\hypert\hmid \G\tr\tj{t}{\phi}$}
      \UnaryInfC{$\hypert\hmid \G,\tj{x}{\terminate}\tr\tj{t}{\phi}$}
      \DisplayProof
     \end{proposition}
    ...
    \begin{example}[Typed processes]
     ...
     wait for input in a channel~$y'$.
      \begin{center}
       ...
       \UnaryInfC{$\tj{z}{\two},\tj{y}{\terminate}\tr\tj z \two$}
       \UnaryInfC{$\tj{y}{\recvtype\two\terminate}\tr\tj{\recvterm y z z}{\two}$}
       \UnaryInfC{$\tj{y}{\recvtype\two\terminate},\tj{x}{\terminate}\tr
       \tj{\recvterm y z z}{\two}$}
       \AxiomC{}
     ...
     After receiving $w'$, the process puts $\inl{\ast}$ in $w'$.
      \begin{center}
       \AxiomC{}
       \UnaryInfC{$\tr\tj\ast\one$}
       \UnaryInfC{$\tj{w'}\terminate$}
       \AxiomC{}
       \UnaryInfC{$\tr\tj\ast\one$}
       \UnaryInfC{$\tr\tj{\inl{\ast}}{\two}$}
       \BinaryInfC{$\tj{w'}{\sendtype\two\terminate}\tr\tj{\sendterm{w'}{\inl\ast}\ast}{\one}$}
       \UnaryInfC{$\tj{w'}{\sendtype\two\terminate},\tj{x'}\terminate\tr\tj{\sendterm{w'}{\inl\ast}\ast}{\one}$}
       \UnaryInfC{$\tj{x'}{\recvtype{\sendtype\two\terminate}\terminate}\tr\tj{
       \recvterm{x'}{w'}{\sendterm{w'}{\inl\ast}{\ast}}}\one$}
       \DisplayProof
      \end{center}
  ...
  \begin{proof} By the derivation in Figure~\ref{fig:processtype}
    ...
    x.cx)u /x]\eval v\hmid \letin{u'\otimes w'}{z\otimes y}{t_1}\eval w
     $}
    \DisplayProof
     \caption{Proof of \thref{processtype}.    The conclusion is identical to our goal up to abbreviations.}
	 ...
	 \begin{example}[Evaluation of communicating processes]
	  \fix{add paragraph}
	   \begin{center}
	    ...
	    \AxiomC{}
	    \UnaryInfC{$\ast\eval\ast$}
	    \BinaryInfC{$\inl\ast\otimes \ast\eval\inl\ast\otimes\ast$}
	    \UnaryInfC{
	    $
	    \letin{\bothside{\terminate}}{y'\otimes y}
	    {\inl\ast\otimes \ast}
	    \eval\inl\ast\otimes\ast
	    $
	    }
	    \UnaryInfC{
	    $
	    \letin{\bothside{\sendtype\two\terminate}}{y'\otimes y}
	    {\recvterm y z z\otimes \sendterm{y'}{\inl\ast}\ast}
	    \eval\inl\ast\otimes\ast
	    $
	    }
	    \UnaryInfC{
	    $
	    \letin{\bothside{\terminate}}{x'\otimes
	    x}{\letin{\bothside{\sendtype\two\terminate}}{y'\otimes
	    y}{}}$}
	    \noLine
	    \UnaryInfC{$
	    {\recvterm y z z\otimes \sendterm{y'}{\inl\ast}\ast}
	    ...
	    \noLine
	    \UnaryInfC{$
	    \left(\sendterm x {y'}{\recvterm y z z}\right)\otimes
	    \left(\recvterm{x'}{w'}{\sendterm{y'}{\inl\ast}\ast}\right)
	    \eval\inl\ast\otimes\ast
	    $
	    }
	    \DisplayProof
