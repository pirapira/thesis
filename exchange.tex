...
We add the semantics for channels.
 \begin{figure}
  ...
  \DisplayProof
  \hfill
  \AxiomC{$\hypere\hmid t\eval v\hmid s\eval w\hmid \hypere'$}
  \UnaryInfC{$\hypere\hmid s\eval w\hmid t\eval v\hmid \hypere'$}
  \DisplayProof
  \ruleskip
  \AxiomC{$\hypere\hmid
...
The situation is essentially similar to $c(\co c)t$.
