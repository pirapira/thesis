...
The typing rules are in Figure~\ref{fig:exchange:rules}.
 ...
 type~$\phi$ is \textit{inhabited}\index{inhabited}.  In other words,
...
\section{Type Safety}
 ...
 \begin{proposition}[Split]
  \label{split}
  If $\hypert\hmid \hypert'$ is derivable for two channel disjoint
  hypersequents,
 ...
 \end{proof}
  ...
  \fix{describe convergence}
  There are two difficult cases for obtaining convergence.
