...
involved free variables~$S$.
 ...
 \begin{figure}
  ...
  \DisplayProof
  \ruleskip
  \AxiomC{$\hypere\hmid t\eval_S v\hmid u\eval_{S'\sqcup\{x,y\}} w$}
  \UnaryInfC{$\hypere\hmid \letin t {x\otimes y} u \eval_{S\sqcup S'} \letin v
  {x\otimes y} w$}
  ...
  \DisplayProof
  \hfill
  \AxiomC{$\hypere\hmid t\eval_{S\sqcup \{x\}} v$}
  \UnaryInfC{$\hypere\hmid \lambda x.t\eval_{S} \lambda x.v$}
  \DisplayProof
  \hfill
  ...
  \hmid  u[v_1/y]\eval_S w$}
  \UnaryInfC{$\hypere \hmid
  \letin t {\lpair{\_,y}} u\eval_S w$}
  \DisplayProof
  \ruleskip
  \AxiomC{$\hypere
  \hmid t\eval_S t'
  ...
  \DisplayProof
  \ruleskip
  \AxiomC{$\hypere\hmid t\eval_\emptyset \inl{v}\hmid u[v/x]\eval_S w$}
  \UnaryInfC{$\hypere\hmid \mat t x u y {u'}\eval_S w$}
  \DisplayProof
  \hfill
  \AxiomC{$\hypere\hmid t\eval_\emptyset \inr{v}\hmid u'[v/y]\eval_S w$}
  \UnaryInfC{$\hypere\hmid \mat t x u y {u'}\eval_S w$}
  \DisplayProof
  \ruleskip
  ...
  \DisplayProof
  \hfill
  \AxiomC{$\hypere\hmid t\eval_\emptyset \bang v\hmid u[v/x]\eval_S w$}
  \UnaryInfC{$\hypere \hmid \letin t {\bang x} u\eval_S w$}
  \DisplayProof
  \hfill
  ...
  s/y]\eval_S v$}
  \UnaryInfC{$\letin t {x@y} u\eval_S v$}
  \DisplayProof
  \hfill
  \AxiomC{$\hypere\hmid t\eval_S t'\hmid u\eval_{BV{p}} u'$}
  \UnaryInfC{$\letin t p u\eval_{S\sqcup S'} \letin {t'} p {u'}$}
  \DisplayProof \\
  \fix{define BV}
  \ruleskip
 ...
 \begin{lemma}
   \label{eval-subst}
  \AxiomC{$\hypere\hmid t\eval_\emptyset v\hmid u[v/x]\eval_S w$}
  \LL{eval-subst}
  \UnaryInfC{$ \hypere\hmid u[t/x] \eval_S w $}
  \DisplayProof
   is admissible.
 \end{lemma}
