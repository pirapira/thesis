...
\DisplayProof
 ...
 The typing system is has two strong properties about structural rules:
 ...
 \begin{corollary}[Amida logic proves any exponential formula]
  If we are to introduce the bang modality of linear logic,
  then any formula of the form $!\phi$ is a theorem.
 \end{corollary}
 ...
 \end{corollary}
 However, the Amida logic itself is consistent (see \thref{smcc} or
...
\begin{align*}
 ...
 \semo{\phi})\text{ or }(t\eval_\emptyset\inr{w}, w \in \semo{\psi})\}\enspace.
\end{align*}
...
$u\in\semo{\G\tr\tj t\phi}$.
 ...
 \end{proposition}
  ...
  This is why we see only $\eval_\emptyset$ in this proof.
   ...
   \end{corollary}
    \begin{proof}
     ...
     $t\eval_\emptyset t'$ is derivable for some $t'$ in $\semo{X}$.
  ...
  \DisplayProof
    ...
    \begin{corollary}[Determinacy of Amida calculus on well-formed terms]
    ...
    \fix{make the sendtype, recvtype standard ! and ?}
...
($X^-, X^+, \one^+,\bot^-$) at the leaves. \fix{rules for atomic units
are they OK?}
 \begin{center}
...
any correct essential net.
 ...
 \begin{theorem}[Soundness and completeness of the esseential nets for
