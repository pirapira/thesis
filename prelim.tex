...
disjunction property today: ``besides, the following holds with full
...
In the sqeuent calculus for intuitionistic propositional logic,
the $\wedge$-right rule can be formulated in either way:
 \begin{center}
  \AxiomC{$\G\tr\phi$}
  \AxiomC{$\D\tr\psi$}
