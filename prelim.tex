...
Frege's \textit{Begriffsschrift}~\citep{frege}.  There, in the section called
``conditionality,''
...
\]
 ...
 y.\lambda z. xzy$, which is $C$, to the logical formula
...
algol 60
landin: a correspondence between algol 60 and church's lambda notation
...
\subsection{Linear Ligic and Monoidal t-Norm Logic}
\label{linear}
