...
\]
 ...
 \gamma))\supset (\alpha\supset(\beta\supset\gamma))$.
 Throughout this thesis, we use colons~$\colon$ to associate terms with types.
...
For example,
 it is waitfreely impossible for each processes to attain the input value of the other
 process.
