...
theory.
\fix{cite someone, from Yatabe-san}
The idea is resolving the liar's paradox ``this sentence is false'' by
assigining the truth value 0.5 to the sentence.  When a sentence has
...
Another computational interests on intermediate logics can be found
