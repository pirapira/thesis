...
strategies are represented by Nakajima trees~\fix{cite
nakajima}\footnote{A Nakajima tree is a B\"ohm tree~\fix{cite something}
represented using de Bruin index.}.
...
based semantics by \fix{cite Danos, Regnier, Malacaria, Mackie}.
...
to Geometry of Interaction~\fix{cite girards and Haghverdi}.
