...
\DisplayProof ($\mathcal H$ or $\G$ has no $X$ freely)
\hfill
%
...
\begin{proof}
 ...
 additively while in $\NMTL$ multiplicatively.\qed
\end{proof}
...
(without using modalities $!$ or $?$),
we conjecture that we can extend their type systems and their process
calculi
with the prelinearity
axiom using the same kind of communication facilities as we used in this paper.
