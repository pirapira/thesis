...
\begin{description}
 ...
 \item[(mat0)]
           $[\inl{t}, \mats xeyf] \red e[v/x] $ \enspace;
 \item[(mat1)]
           $[\inr{t}, \mats xeyf] \red f[t/y] $ \enspace;
 \item[(com0)]
...
\begin{align*}
 ...
 \nsem{\phi\oplus\psi}=& \{(\mats xey{e'}, f)\mid\\ &
 e[v/x]\conc f\conc f'\in\bbot \text{ for all } (v,f')\in\nsem{\phi}\rightarrow\bbot\text{
 and }\\ &
 e'[w/y]\conc f\conc f'\in\bbot \text{ for all } (w,f')\in\nsem{\psi}\rightarrow\bbot\}
 \\
 \nsem{\forall X\phi}=&
