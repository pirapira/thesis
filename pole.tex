...
the hyperlambda calculus for G\"odel--Dummett logic presented in
...
polymorphism\fix{correct term?} is managable \fix{cite},
...
\begin{example}
 ...
 $\forall X\forall Y((X\limp Y)\oplus (Y\limp X))$ (\fix{refer}),
 this term satisfies the condition of \thref{spec:prelin}.
 By (dist),
...
and to $[u,\pi], S_\epsilon[c\mapsto u,\co c\mapsto t]$ (Figure~\fix{add}).
