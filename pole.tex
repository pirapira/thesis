\chapter{Prelinear Parametricity}
...
This work is a reformulation of \citet{hiraiflops2012} in the setting of
second-order logic.
This allowed parametricity argument.
Also, differently from Hirai's hypersequent formulation~\citep{hiraiflops2012},
...
Below, we sometimes omit the outermost parentheses (e.g. [ and ]) for multisets.
   ...
   \item[($\limp$I, \textminus)]
	...
	\begin{enumerate}[label=\textit{(\arabic{*})}]
	 \item Take any
	       ...
	       t_0\cdot\pi\conc\vec{e}\conc e_0\conc e_1\enspace.
	       \]
	       The executable reduces to
	       \[
		t_1[\ast_{t_0}][\vec{g}/\G],\pi\conc\vec{e}\conc e_0\conc{e_1}\enspace.
	       \]
	 ...
	 \item Take any $(v,w,e')\in\sempair{\theta,\tau}$,
	       ...
	       e'\conc \vec{e}\conc \vec{f} \conc{e_0'}\conc{e_1'}\enspace.
	       \]
	...
	\begin{enumerate}[label=\textit{(\arabic{*})}]
	 ...
	 \begin{description}
	  \item[(case $\G_0 = \tj{x}{\sigma},\hat\G_0$)]
	       ...
	       u' ,\sigma\conc \hat e\conc {\vec{e_1}}\conc
	       {e''}\conc{f''}\enspace.
	       \]
	       where
	       $u' = u[w/y][\vec{d}/\D]$ and
	       $\hat e= e'\conc \vec{e_0}\conc \vec{f}$.
	       By (push), this executable reduces to
	       \[
