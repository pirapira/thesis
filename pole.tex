...
monoidan t-norm logic \fix{cite something}.
   ...
   \item[(W, \textminus)]
	...
	\begin{enumerate}[label=\textit{(\arabic{*})}]
	 \item Take any $(\vec{g'}, e'')\in\sem{\G'}$ and $(\hat t,\hat
	       ...
	       By \thref{prop:w}, $(t[\hat t/\hat x][\vec{g'}/\G'],
...
We give a translation from MTL formulae to MTL2 formulae by the outer
...
\fix{define substitution instance of a mtl2 formula (which is a mtl-formula)}
...
\end{proof}
 \begin{figure}
  ...
  \AxiomC{}
  \LL{Ax}
  \useq{\bu{\D}_0}{\bu{\D}_0}
  \AxiomC{}
  \LL{Ax}
  \useq{\bu{\D}_1\limp\bu{\G}_0}{\bu{\D}_1\limp\bu{\G}_0}
  \AxiomC{}
  \LL{Ax}
  \useq{\bu{\D}_1}{\bu{\D}_1}
  \LL{$\limp$E}
  \bseq{\bu{\D}_1\limp\bu{\G}_0,\bu{\D}_1}{\bu{\G}_0}
  \doubleLine
  \bseq{\bu\D_1\limp\bu\G_0,\bu\D_0,\bu\D_1}{\bu{(\D_0\otimes\G_0)}}
  \DisplayProof
   \end{center}
  \ruleskip
  Part B
  \newcommand{\zerozerophi}{\bu{(\D_0\otimes\G_0)}\limp\bu{\phi}}
  \newcommand{\oneonepsi}{\bu{(\D_1\otimes\G_1)}\limp\bu{\psi}}
  \newcommand{\DoneGzero}{\bu\D_1\limp\bu\G_0}
  \newcommand{\GzeroDone}{\bu\G_0\limp\bu\D_1}
  \newcommand{\concL}{\bu{(\D_0\otimes\D_1)}\limp \bu\phi}
  \newcommand{\concR}{\bu{(\G_0\otimes\G_1)}\limp \bu\psi}
   \begin{center}
  \AxiomC{}
  \LL{Ax}
  \useq{\zerozerophi}{\zerozerophi}
  \AxiomC{Part A}
  \LL{$\limp$E}
  \bseq{\DoneGzero,\zerozerophi,\bu\D_0,\bu\D_1}{\bu\phi}
  \doubleLine
  \useq{\DoneGzero,\zerozerophi,\bu{(\D_0\otimes\D_1)}}{\bu\phi}
  \LL{$\limp$I}
  \useq{\DoneGzero,\zerozerophi}{\concL}
  \LL{$\oplus$I}
  \useq{\DoneGzero,\zerozerophi}{(\concL)\oplus (\concR) =: \theta}
  \DisplayProof
   \end{center}
  \ruleskip
  Part B' is symmetric to Part B concluding
   \begin{center}
    \aseq{
    \GzeroDone,\oneonepsi}{\concR}
    \LL{$\oplus$I}
    \useq{\GzeroDone,\oneonepsi}{\theta}
    \DisplayProof
   \end{center}
  Part C
   \begin{center}
    ...
    \AxiomC{Part B'}
    \LL{Com}
    \bseq{\zerozerophi,\oneonepsi}{\theta}
    \LL{$\oplus$I}
    \useq{\zerozerophi,\oneonepsi}{\mathcal{\bu{H}}\oplus
    \theta}
    \DisplayProof
   \end{center}
  \ruleskip
  Part D
   \begin{center}
    \AxiomC{hyp. of (com) in $\HLBCK$}
    \useq{}{\bu{\mathcal H}\oplus(\oneonepsi)}
    \AxiomC{}
    \LL{Ax}
    \useq{\bu{\mathcal H}}{\bu{\mathcal H}}
    \LL{$\oplus$I}
    \useq{\bu{\mathcal H}}{\bu{\mathcal H} \oplus \theta}
    \LL{W}
    \useq{\bu{\mathcal H}, \zerozerophi}{\bu{\mathcal H} \oplus \theta}
    \AxiomC{Part C}
    \LL{$\oplus$E}
    \tseq{\zerozerophi}{\bu{\mathcal H}\oplus\theta}
    \DisplayProof
   \end{center}
  \ruleskip
  Main Part
   \begin{center}
    \AxiomC{hyp. of (com) in $\HLBCK$}
    \useq{}{\bu{\mathcal H}\oplus (\zerozerophi)}
    \AxiomC{}
    \LL{Ax}
    \useq{\bu{\mathcal H}}{\bu{\mathcal H}}
    \LL{$\oplus$I}
    ...
    \AxiomC{Part D}
    \LL{$\oplus$E}
    \tseq{}{\bu{\mathcal H}\oplus((\concL)\oplus (\concR))}
    \DisplayProof
   \end{center}
...
\fix{There are no communication there.}
