\chapter{Prelinearity Axiom as an
 ...
 the heights of the derivations.
  ...
  \item[(D, \textminus)] Both statements follow immediately from the
   ...
   \item[($\imp$I, \textminus)]
       ...
       \aseq{\tj {z}{\phi_0},\G}{\tj t{\phi_1}}
       \useq{\G}{\tj{\lambda {z}.t}{\phi_0\imp{\phi_1}}}
       \DisplayProof.
  ...
  \item[($\imp$E, \textminus)]
	 The derivation for $t$ ends as
	     \aseq{\G}{\tj{t_0}{\phi_1\imp\phi'}}
	     \aseq{\G}{\tj{t_1}{\phi_1}}
	     \bseq{\G}{\tj{t_0(t_1)}{\phi'}}
	     \DisplayProof
  ...
  \item[($\forall$E, \textminus)]
   \item[(Com, \textminus)]
       The derivation for $t$ ends in
       \[
       \aseq{\tj{\hat x}{\theta\imp\tau},\D_0}{\tj{t_0}{\phi'}}
       \aseq{\tj{\hat y}{\tau\imp\theta},\D_1}{\tj{t_1}{\phi'}}
