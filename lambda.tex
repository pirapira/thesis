...
&\llparenthesis
 ...
 \end{example}
  ...
  \begin{proposition}
   ...
   final system snapshot~$s$ satisfies \fix{is this correct? usage of s}
   ...
   \begin{proof}
    ...
    \begin{description}
     \item[$ij$-com]
	  ...
	  By the form of programs,
	  there exists an execution of $\semo{\hypert_0\hmid
	  \imapsto{M}}$
	  whose final system snapshot map contains process snapshots
	  $s'_l$
	  that map program variables as:
	  \begin{align*}
	   \semoi{\overline{\hypert_0}\hmid \imapsto{M}}&\mapsto
     ...
     \item[EC]
	  ...
	  \begin{align*}
       ...
       M'_i}
	  \end{align*}
	  whose final system snap shot is $\tuple{\vec s, \vec v}$.
    \end{description}
   \end{proof}
