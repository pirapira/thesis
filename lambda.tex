...
%% local imp intro
  \UnaryRule
   ...
   {$\hypert\hmid\Gamma\tr \tj{\imapsto{\lambda x.M}}{[i](\varphi\supset\psi)}$}
                       \hfill
%% local imp elim
  \BinaryRule{$\hypert_0\hmid\Gamma \tr \tj {\imapsto{M}}{[i](\varphi\supset \psi)}$}
  {$\hypert_1\hmid\Gamma\tr \tj {\imapsto{N}}{[i]\varphi}$}
  {}
  {$\cotuple{\hypert_0,\hypert_1}\hmid\Gamma\tr \tj{\imapsto{MN}}{[i]\psi}$}
                       \vskip 2mm
%% local conj intro
\BinaryRule{$\hypert_0\hmid\Gamma\tr \tj {\imapsto{M}}{[i]\varphi}$}
   {$\hypert_1\hmid\Gamma\tr \tj {\imapsto{N}}{[i]\psi}$}
   {}
   {$\cotuple{\hypert_0,\hypert_1}\hmid\Gamma\tr
     \tj{\imapsto{\lpair{M,N}}}{[i](\varphi\wedge\psi)}$}
   \vskip 2mm
%% local conj elim
  \UnaryRule
...
%% local disj elim
\TrinaryRule
   {$\hypert_0\hmid\Gamma\tr \tj{\imapsto{M}}{[i](\varphi\vee\psi)}$}
   {$\hypert_1\hmid\tj x{[i]\phi},\G\tr \tj{\imapsto{N_0}}{[i]\theta}$}
   {$\hypert_2\hmid\tj y{[i]\psi},\G\tr \tj{\imapsto{N_1}}{[i]\theta}$}
   {}
   {$\cotuple{\cotuple{\hypert_0,\hypert_1},\hypert_2}\hmid\Gamma \tr
