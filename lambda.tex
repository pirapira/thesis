...
%% conj elim
  \UnaryRule
   {$\hypert\hmid\Gamma\tr \gpair{M,N}\colon\m\varphi\wedge\m\psi$}
   {}
  ...
  \UnaryRule
   {$\hypert\hmid\Gamma\tr \gpair{M,N}\colon\m\varphi\wedge\m\psi$}
   {}
   {$\hypert\hmid\Gamma\tr\gpir N\colon\m\psi$}
\vskip 2mm
%% disj intro
  \UnaryRule
   {$\hypert\hmid\Gamma\tr M\colon\m\varphi$}
...
\begin{definition}[Basic reduction]
 ...
 \conf{}{M[O/x]}$
  ...
  \item $\conf{}{\spir{\spair{M,N}}} \breduce
	 \conf{}{             N }$
  \item $\conf{}{\mat{\sinl M}x N y O} \breduce
	 \conf{}{              N[M/x]}$
  \item $\conf{}{\mat{\sinr M}x N y O} \breduce
	 \conf{}{                  O[M/y]}$
 \end{itemize}
\end{definition}
...
\begin{itemize}
 ...
 \item {
       ...
       \bsinr{y}. {\left(\mat  O u P v Q\right)}
                      )
       $}
