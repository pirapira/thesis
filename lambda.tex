...
\ruleskip
 ...
 \G\tr\tj{\cotuple{M_i',N_i'}}{(\phi_i)_{i\in I}}$}
...
schedule~$\sigma$,
 ...
 \fix{show example not solvable, why? see saks or see below 40min}
...
&\phantom{\llparenthesis}
  ...
  \end{align*}
  \fix{remove types and contexts: they are not necessary}
 \end{example}
