...
\fix{do not use the projection apostrophy.  apply a process number.}
...
\begin{description}
 ...
 &(d\leftarrow \semoi{\hypert_0\hmid\overline{M}}'; \p
 y\leftarrow c;)_j; \\
 &(c\leftarrow \semoi{\hypert_1\hmid\overline{N}}'; \p
 ...
 \item[EC]
      ...
      \end{align*}
      \fix{above, give an example of this kind of notations}
 \item[EE]
      \begin{align*}
...
\begin{align*}
 ...
 \lambda x. \semoi{\hypert\hmid\overline{\imapsto{M}}}'\right)_i \enspace,\\
...
\begin{align*}
 ...
 M}}'\semoi{\hypert_1\hmid \overline N}'\right)_i\enspace,\\
...
\begin{align*}
 ...
 \left(\p z \leftarrow
 \lpil {\semoi{\hypert\hmid\overline{\imapsto{M}}}'}\right)_i\enspace, \\
...
\begin{align*}
 ...
 \left(\p z \leftarrow
 \lpir{ \semoi{\hypert\hmid\overline{\imapsto{M}}}' }\right)_i\enspace, \\
...
\begin{align*}
 ...
 & \semo{\hypert\hmid \imapsto{M}}; \left(\p z \leftarrow
 \linl{ \semoi{\hypert\hmid\overline{\imapsto{M}}}'}\right)_i\enspace, \\
...
\begin{align*}
 ...
 \left(\p z \leftarrow
 \linr{\semoi{\hypert\hmid\overline{\imapsto{M}}}'}\right)_i\enspace, \\
...
$\semo{M}; ({\p o}_i\leftarrow \pi_i(\semoi{\overline M}'))_{i\in\processes}$,
...
\fix{finish the proof of soundness}
