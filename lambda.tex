...
We assume countably inifinitely many \textit{processes}\index{process}.
...
\begin{itemize}
 ...
 \conf{}{\imapsto{\inr M}}$;
 \item
   $\conf{}{\imapsto{\cotuple{\inl M,\abort}}}\areduce
 \conf{}{{M}}$;
 \item $\conf{}{\imapsto{\cotuple{M,N}}}\areduce \conf{}{\imapsto{\inl M}}$ where
...
&\llparenthesis
 ...
 For the other direction, we can use a universal waitfree problem.
