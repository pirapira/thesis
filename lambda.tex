...
%% external structural
 ...
 \vskip 2mm
 \UnaryRule
 {$\hyper\hmid\Gamma\vdash \m\varphi\hmid\Gamma\vdash \m\psi$}
 {EC}
 {$\hyper\hmid\Gamma\vdash (\m\varphi \lor \m\psi) \lor (\m\phi\land\m\psi)$}
 \hfill
 \UnaryRule
...
\tr \tj{\left[{\lambda x. (\comodL)x} ,\quad {\lambda
 y.(\comodR)y} \right]}
 {([0](P\supset Q)\lor [1](Q\supset P))  \lor ([0](P\supset Q)\land [1](Q\supset P))} $}
\DisplayProof
...
\vskip 2mm
 \UnaryRule
 {$\hypert\hmid\Gamma\tr\tj M {\m\phi}\hmid\Gamma\tr \tj N {\m\psi}$}
 {}
 {$\hypert\hmid\Gamma\tr \tj
 {\cotuple{M,N}}{(\m\phi \lor \m\psi)\lor(\m\phi\land\m\psi)}$}
\hfill
 \UnaryRule
...
\begin{itemize}
 ...
 \conf{}{\ginl{\ginr{M}}}$, and
   $\conf{}{\cotuple{M,\abort}}\areduce
 \conf{}{\ginl{\ginl{M}}}$
 \item $\conf{}{\cotuple{M,N}}\areduce \conf{}{\ginr{\gpair{M,N}}}$ where
...
\sinl{C[\bullet]}\mid
\sinr{C[\bullet]}\mid
\spair {C[\bullet], N}\mid \\&
\spair {M, C[\bullet]}\mid
